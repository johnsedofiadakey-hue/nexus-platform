...
"[project]/apps/agent/src/app/api/mobile/pulse/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!session || !session.user?.id) {
            console.log("❌ Pulse Rejected: No Session", {
                session
            });
        ...
        const agent = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$agent$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
            where: {
        ...
        if (agent.shop) {
            ...
            const a = Math.sin(dLat / 2) * Math.sin(dLat / 2) + Math.cos(lat * Math.PI / 180) * Math.cos(agent.shop.latitude * Math.PI / 180) * Math.sin(dLng / 2) * Math.sin(dLng / 2);
            ...
            if (!isInside) {
                if (agent.isInsideZone) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$agent$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].disciplinaryRecord.create({
                        data: {
                            userId: agent.id,
        ...
        // 6. Update Live State
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$agent$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
            where: {
                id: agent.id
            },
            data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__edad0ff9._.js.map