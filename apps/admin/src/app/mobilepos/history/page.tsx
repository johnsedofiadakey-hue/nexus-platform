          ...
          filteredSales.map((sale) => (
            ...
            >
              ...
              <div className="text-right">
                ...
                <span className={`text-[9px] font-bold px-2 py-0.5 rounded-full uppercase flex items-center justify-end gap-1 ${sale.paymentMethod === 'MOMO' ? 'text-yellow-500 bg-yellow-500/10' : 'text-emerald-500 bg-emerald-500/10'
                  }`}>
