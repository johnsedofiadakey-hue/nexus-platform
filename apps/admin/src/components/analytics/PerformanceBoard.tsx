...
import {
   TrendingUp, ShoppingBag, Award, Target, Users, FileText, Edit3, Save, Calendar, Package
} from "lucide-react";
...
export default function PerformanceBoard({ sales = [], dailyReports = [], targets = {}, onSaveTargets }: any) {
   ...
   const stats = useMemo(() => {
      ...
      // Simple 1% Commission Logic
      const estCommission = totalRevenue * 0.01;

      return { totalRevenue, totalVolume, totalWalkIns, conversionRate, estCommission, count: sales.length };
   }, [sales, dailyReports]);
            ...
            <div className="flex justify-between items-start mb-6 relative z-10">
               <div>
                  <div className="flex items-center gap-3 mb-2">
                     ...
                     <h3 className="text-sm font-black uppercase tracking-widest">Monthly Sales Targets</h3>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
               ...
               <div>
                  <div className="flex justify-between text-xs font-bold mb-2 uppercase tracking-wider">
                     <span className="text-slate-400">Sales Goal</span>
                     {isEditingTargets ? (
                        <input
                           type="number"
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-[2.5rem] border border-slate-200 shadow-sm">
               <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                     ...
                     <h3 className="text-xl font-black text-slate-900">₵ {stats.totalRevenue.toLocaleString()}</h3>
                  </div>
               </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-[2.5rem] border border-slate-200 shadow-sm">
               <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                     <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Sales Volume</p>
                     <h3 className="text-xl font-black text-slate-900">{stats.totalVolume} Items</h3>
                  </div>
               </div>
            </div>

            <div className="bg-slate-900 p-6 rounded-[2.5rem] shadow-xl shadow-slate-900/10 text-white">
               <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                     ...
                     <h3 className="text-xl font-black text-white">₵ {stats.estCommission.toLocaleString()}</h3>
                  </div>
               </div>
            </div>
         </div>
