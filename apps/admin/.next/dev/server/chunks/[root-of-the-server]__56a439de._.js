...
"[project]/apps/admin/src/app/api/hr/team/list/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const orgFilter = user.role === "SUPER_ADMIN" && !user.organizationId ? {} // Super admin without org sees all
         : {
            organizationId: user.organizationId
        };
        const staff = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findMany({
            where: orgFilter,
            orderBy: {
                createdAt: "desc"
            },
        ...
        if (error.message.includes("prepared statement")) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$19$2e$2$2e$4_react$40$19$2e$2$2e$4_$5f$react$40$19$2e$2$2e$4$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Database Cache Desync. Please retry in 5s.",
                code: "POOL_RESET"
            }, {
                status: 503
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__56a439de._.js.map