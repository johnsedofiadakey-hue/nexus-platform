...
"[project]/apps/admin/src/app/api/inventory/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    try {
        ...
        if (shopId) {
            ...
            const shop = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shop.findUnique({
                where: {
                    id: shopId
                },
                select: {
        ...
        const [total, products] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.count({
                where: whereClause
            }),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d9786046._.js.map